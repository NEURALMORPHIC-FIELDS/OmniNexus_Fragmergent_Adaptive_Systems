...
class OmniNexus:
    ...
    def run_cycle(
        ...
        if smart_navigation and np.random.rand() > 0.3:
    ...
    def _calculate_reward(
        ...
        """
        energy_component = 0.5 * (self.avatar.energy / 100.0)
        mode_component = 0.3 * (1.0 if mode == 'optical' else 0.0)
        richness_component = 0.2 * richness
